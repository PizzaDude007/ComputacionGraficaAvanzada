...
//uniform sampler2D porcentajeMezcla = 0.3;
...
vec3 calculateDirectionalLight(Light light, vec3 direction){
	...
	vec3 finalColor = mix(textureColor1, textureColor2, 0.3); //utlimo parametro es factor de mezcla 0.3 = 70% de primer argumento, 30% del segundo
